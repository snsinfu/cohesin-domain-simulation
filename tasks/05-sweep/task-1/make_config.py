...
def resolve_config(
    ...
    *,
    ...
    # Parameterize association reactions
    association_rate = association_constant / association_lifetime
    dissociation_rate = 1 / association_lifetime
    ...
    chain["association_features"] = (
        association_features + chain.get("association_features", [])
    )
